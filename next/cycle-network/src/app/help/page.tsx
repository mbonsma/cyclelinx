  ...
  <HelpSection title="Getting started">
    <HelpSectionText>
      <HelpSectionParagraph>
        The first thing you will see on the Cyclinx app is a map of the Greater
        Toronto Area. Roads where new bike lanes can be added are marked in a
        light blue colour.
      </HelpSectionParagraph>
      <HelpSectionParagraph>
        The panel on the left allows you to view existing bike lanes by type. It
        also allows you to select a <Strong>"budget"</Strong> (given in
        kilometers of new bike lanes). When a budget is selected, the map will
        be updated with new bike routes that scientists have determined to be
        optiminal given the existing infrastructure.
      </HelpSectionParagraph>
    </HelpSectionText>
    <HelpSectionImage
      alt="help-1"
...
const HelpSectionTwo: React.FC = () => (
  <HelpSection title="Viewing pre-computed routes">
    <HelpSectionText>
      <HelpSectionParagraph>
        After selecting a budget, the proposed new cycling routes will appear as
        blue lines on the map. The heat map (shown in green in the image) will
        indicate the accessibility created by the proposed infrastructure. The

...
Revision ID: cab5bffc6a1d
Revises:
Create Date: 2024-10-08 18:39:20.931920
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("budget_id", "project_id"),
    )
    op.create_table(
        "budget_scores",
        sa.Column("id", sa.Integer(), nullable=False),
